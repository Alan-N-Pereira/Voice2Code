...
function VersionLink(props: { version?: string }): JSX.Element {
    ...
    return (
        <a target="_blank" rel="noreferrer" href={`https://github.com/Alan-N-Pereira/speech-to-code/releases/tag/v${version}`}>
            {version}
        </a>
    )
}
...
const texts: Record<string, Record<string, any>> = {
    'en-US': {
        'current_editor_exp': 'Which code editor is Voice2Code controlling ? <br/><br/>Preferred option is Visual Studio Code.'
    },
    'pt-BR': {
        'Help': 'Ajuda',
        'Modules': 'Módulos',
